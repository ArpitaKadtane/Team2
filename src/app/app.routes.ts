...
export const routes: Routes = [
  ...
  {
    path: 'instructor/successfully-submitted',
    component: FormsubmittedComponent,
  },
  {
    path: 'instructor/applicants-details',
    component: InstructorAppliedComponent,
  },
  ...
  { path: 'NotFound', component: ErrorPageComponent },
  {
    ...
    children: [
      ...
      { path: 'upcoming-Assessments', component: UpcomingEventsComponent },
      {
        ...
        component: CourseContentViewerComponent,
      },
      // Added profile route here
    ],
  },
  // Instructor Profile route (for dynamic instructor profile by ID)
  { path: 'profile/:id', component: ProfileComponent }, // Correct path for the instructor profile
